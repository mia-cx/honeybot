...
const OptionalPreventionAction = Schema.optionalKey(
  Schema.Literals(preventionActions),
);
const OptionalPunishmentAction = Schema.optionalKey(
...
const EnvSchema = Schema.Struct({
  ...
  DEFAULT_TEXT_PRIMARY_PROVIDER: Schema.String,
  DEFAULT_TEXT_PRIMARY_MODEL: Schema.String,
  DEFAULT_IMAGE_PRIMARY_PROVIDER: Schema.String,
  DEFAULT_IMAGE_PRIMARY_MODEL: Schema.String,
  ADDITIONAL_TEXT_SIGNAL_PROVIDER: Schema.String,
  ADDITIONAL_TEXT_SIGNAL_MODELS: Schema.Array(Schema.String),
  ADDITIONAL_IMAGE_SIGNAL_PROVIDER: Schema.String,
  ADDITIONAL_IMAGE_SIGNAL_MODELS: Schema.Array(Schema.String),
  ...
  HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DURATION_SECONDS:
    OptionalNonNegativeIntegerOrNull,
  ...
  HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DURATION_SECONDS:
    OptionalNonNegativeIntegerOrNull,
  ...
  HONEYBOT_DEFAULT_PUNISHMENT_DURATION_SECONDS:
    OptionalNonNegativeIntegerOrNull,
...
export const deploymentGuildDefaults: GuildConfig = defaultGuildConfig({
  moderationChannelId:
    env.HONEYBOT_DEFAULT_MODERATION_CHANNEL_ID ??
    codeDefaults.moderationChannelId,
  crosschannelEnabled:
  ...
  knownImageSimilarityThreshold:
    env.HONEYBOT_DEFAULT_KNOWN_IMAGE_SIMILARITY_THRESHOLD ??
    codeDefaults.knownImageSimilarityThreshold,
  knownTextSimilarityThreshold:
    env.HONEYBOT_DEFAULT_KNOWN_TEXT_SIMILARITY_THRESHOLD ??
    codeDefaults.knownTextSimilarityThreshold,
  evidenceConfidenceThreshold:
    env.HONEYBOT_DEFAULT_EVIDENCE_CONFIDENCE_THRESHOLD ??
    codeDefaults.evidenceConfidenceThreshold,
  reviewBypassEnabled:
    env.HONEYBOT_DEFAULT_AUTO_PUNISH_ENABLED ??
    codeDefaults.reviewBypassEnabled,
  punishmentDmNotify:
    env.HONEYBOT_DEFAULT_PUNISHMENT_DM_NOTIFY ??
    codeDefaults.punishmentDmNotify,
  retentionCaseDays:
    env.HONEYBOT_DEFAULT_RETENTION_CASE_DAYS ?? codeDefaults.retentionCaseDays,
  crosschannelMaxEntriesPerGuild:
    env.HONEYBOT_DEFAULT_CROSSCHANNEL_MAX_ENTRIES_PER_GUILD ??
    codeDefaults.crosschannelMaxEntriesPerGuild,
  crosschannelMaxEntriesPerUser:
    env.HONEYBOT_DEFAULT_CROSSCHANNEL_MAX_ENTRIES_PER_USER ??
    codeDefaults.crosschannelMaxEntriesPerUser,
  globalBansEnabled:
    env.HONEYBOT_DEFAULT_GLOBAL_BANS_ENABLED ?? codeDefaults.globalBansEnabled,
  honeypotChannelIds: [
    ...(env.HONEYBOT_DEFAULT_HONEYPOT_CHANNEL_IDS ??
      codeDefaults.honeypotChannelIds),
  ],
  moderatorUsers: [
    ...(env.HONEYBOT_DEFAULT_MODERATOR_USER_IDS ?? codeDefaults.moderatorUsers),
  ],
  moderatorRoles: [
  ...
  policies: {
    honeypot_prevention: policyDefaults(
      codeDefaults.policies.honeypot_prevention,
      {
        ...
        durationSeconds:
          env.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DURATION_SECONDS,
        roleId: env.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_ROLE_ID,
        deleteMessages:
          env.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DELETE_MESSAGES,
      },
    ),
    crosschannel_prevention: policyDefaults(
      codeDefaults.policies.crosschannel_prevention,
      {
        actionType: env.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_ACTION,
        durationSeconds:
          env.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DURATION_SECONDS,
        roleId: env.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_ROLE_ID,
        deleteMessages:
          env.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DELETE_MESSAGES,
      },
    ),
...
function policyDefaults(
  base: Policy,
  overrides: PolicyDefaultOverrides,
): Policy {
  return {
    scope: base.scope,
...
function normalizeEnv(raw: NodeJS.ProcessEnv): Record<string, unknown> {
  return compact({
    ...
    DEFAULT_TEXT_PRIMARY_PROVIDER: stringDefault(
      raw.DEFAULT_TEXT_PRIMARY_PROVIDER,
      'openrouter',
    ),
    ...
    MODERATION_ACTION_LIMIT_PER_GUILD: positiveInteger(
      raw.MODERATION_ACTION_LIMIT_PER_GUILD,
      10,
    ),
    MODERATION_ACTION_WINDOW_SECONDS: positiveInteger(
      raw.MODERATION_ACTION_WINDOW_SECONDS,
      60,
    ),
    ...
    HONEYBOT_DEFAULT_MODERATION_CHANNEL_ID: optionalString(
      raw.HONEYBOT_DEFAULT_MODERATION_CHANNEL_ID,
    ),
    HONEYBOT_DEFAULT_HONEYPOT_CHANNEL_IDS: optionalCsv(
      raw.HONEYBOT_DEFAULT_HONEYPOT_CHANNEL_IDS,
    ),
    HONEYBOT_DEFAULT_MODERATOR_USER_IDS: optionalCsv(
      raw.HONEYBOT_DEFAULT_MODERATOR_USER_IDS,
    ),
    HONEYBOT_DEFAULT_MODERATOR_ROLE_IDS: optionalCsv(
      raw.HONEYBOT_DEFAULT_MODERATOR_ROLE_IDS,
    ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_ENABLED: optionalBoolean(
    ...
    HONEYBOT_DEFAULT_KNOWN_IMAGE_SIMILARITY_THRESHOLD: optionalThreshold(
      raw.HONEYBOT_DEFAULT_KNOWN_IMAGE_SIMILARITY_THRESHOLD,
    ),
    HONEYBOT_DEFAULT_KNOWN_TEXT_SIMILARITY_THRESHOLD: optionalThreshold(
      raw.HONEYBOT_DEFAULT_KNOWN_TEXT_SIMILARITY_THRESHOLD,
    ),
    HONEYBOT_DEFAULT_EVIDENCE_CONFIDENCE_THRESHOLD: optionalThreshold(
      raw.HONEYBOT_DEFAULT_EVIDENCE_CONFIDENCE_THRESHOLD,
    ),
    HONEYBOT_DEFAULT_AUTO_PUNISH_ENABLED: optionalBoolean(
      raw.HONEYBOT_DEFAULT_AUTO_PUNISH_ENABLED,
    ),
    HONEYBOT_DEFAULT_PUNISHMENT_DM_NOTIFY: optionalBoolean(
      raw.HONEYBOT_DEFAULT_PUNISHMENT_DM_NOTIFY,
    ),
    HONEYBOT_DEFAULT_RETENTION_CASE_DAYS: optionalPositiveInteger(
      raw.HONEYBOT_DEFAULT_RETENTION_CASE_DAYS,
    ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_MAX_ENTRIES_PER_GUILD:
      optionalPositiveInteger(
        raw.HONEYBOT_DEFAULT_CROSSCHANNEL_MAX_ENTRIES_PER_GUILD,
      ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_MAX_ENTRIES_PER_USER: optionalPositiveInteger(
      raw.HONEYBOT_DEFAULT_CROSSCHANNEL_MAX_ENTRIES_PER_USER,
    ),
    HONEYBOT_DEFAULT_GLOBAL_BANS_ENABLED: optionalBoolean(
      raw.HONEYBOT_DEFAULT_GLOBAL_BANS_ENABLED,
    ),

    HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_ACTION: optionalString(
      raw.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_ACTION,
    ),
    HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DURATION_SECONDS:
      optionalNullableNonNegativeInteger(
        raw.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DURATION_SECONDS,
      ),
    HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_ROLE_ID: optionalString(
      raw.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_ROLE_ID,
    ),
    HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DELETE_MESSAGES: optionalBoolean(
      raw.HONEYBOT_DEFAULT_HONEYPOT_PREVENTION_DELETE_MESSAGES,
    ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_ACTION: optionalString(
      raw.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_ACTION,
    ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DURATION_SECONDS:
      optionalNullableNonNegativeInteger(
        raw.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DURATION_SECONDS,
      ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_ROLE_ID: optionalString(
      raw.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_ROLE_ID,
    ),
    HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DELETE_MESSAGES: optionalBoolean(
      raw.HONEYBOT_DEFAULT_CROSSCHANNEL_PREVENTION_DELETE_MESSAGES,
    ),
    HONEYBOT_DEFAULT_PUNISHMENT_ACTION: optionalString(
      raw.HONEYBOT_DEFAULT_PUNISHMENT_ACTION,
    ),
    HONEYBOT_DEFAULT_PUNISHMENT_DURATION_SECONDS:
      optionalNullableNonNegativeInteger(
        raw.HONEYBOT_DEFAULT_PUNISHMENT_DURATION_SECONDS,
      ),
    HONEYBOT_DEFAULT_PUNISHMENT_ROLE_ID: optionalString(
      raw.HONEYBOT_DEFAULT_PUNISHMENT_ROLE_ID,
    ),
    HONEYBOT_DEFAULT_PUNISHMENT_DELETE_MESSAGES: optionalBoolean(
      raw.HONEYBOT_DEFAULT_PUNISHMENT_DELETE_MESSAGES,
    ),
  });
}
...
function csvDefault(value: string | undefined, fallback: string[]) {
  const trimmed = value?.trim();
  return trimmed ? parseCsv(trimmed) : fallback;
}
